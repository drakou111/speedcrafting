  ...
  methods: {
    ...
    handleSlotHover(event) {
      ...
      if (this.currentItem !== null) {
        if (
          ...
          this.leftDragSlots.forEach((slot) => {
            slot.content.count -= difference;
          });

          this.currentItem.count = this.itemCount % countAfter; //countBefore..?
        }
      }
    ...
    getOverflow() {
      ...
      this.slots.forEach((slot) => {
        if (slot.content.extra !== null) {
          sum += slot.content.extra;
        }
      });
      return sum;
    },
    ...
    handleSlotOut() {
      ...
      if (this.currentItem !== null) {
        if (
          ...
          if (this.slots[this.slotIndex].content === null) {
            ...
            this.slots[this.slotIndex].content.count += this.currentItem.count;
            this.currentItem.count = 0;
          }
        }
      }
      ...
      if (!this.leftDragSlots.includes(this.slotIndex) && this.leftDown) {
        this.leftDragSlots.push(this.slotIndex);
      }
